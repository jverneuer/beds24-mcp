...
export declare class ChannelsOps {
    private client;
    constructor(client: Beds24Client);
    /** Read channel settings. `propertyId` is required (the API enforces it). */
    get(query: ChannelQuery): Promise<Beds24Response<ChannelSettingsResponse>>;
    /**
     ...
     */
    configure(settings: ChannelSettings | ChannelSettings[]): Promise<Beds24Response<ChannelSettingsWriteResponse>>;
    /** Read Airbnb listings for the account. `airbnbUserId` is required. */
    airbnbListings(query: AirbnbListingsQuery): Promise<Beds24Response<AirbnbListingsResponse>>;
}
