...
export class InventoryOps {
	 ...
	 */
	async getOffers(query: OffersQuery): Promise<Beds24Response<OffersResponse>> {
	 ...
	 */
	async getUnitBookings(query: UnitBookingsQuery = {}): Promise<Beds24Response<UnitBookingsResponse>> {
